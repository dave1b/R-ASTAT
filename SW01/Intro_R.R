...
verschiedenes <- c(2, 'traurig', 5.3, 'JA', 
                   "schön", "traurig")
...
# na.rm=TRUE; die Option ist hier na.rm=... und steht "für na remove"
...
setwd("/Users/davebrunner/myCloud/HSLU/Module/3. Semester/ASTAT/R-Code")
...
temp <- read.csv("/Users/davebrunner/myCloud/HSLU/Module/3. Semester/ASTAT/R-Code/weather.csv")
...
write.table(temp1, file = "weather1.csv", sep = ",")
...
legend(x = 1, y = 25, 
       legend = colnames(temp), col = farben, lty = 1)
